...
fragment = '''    <article class="ref" id="kepler-distance-audit">
      ...
      <div class="ref-body">
        <div class="meta-grid">
          ...
          <div class="meta-label">Borderline check</div>
          <div class="meta-value"><a href="https://kepler.gl/demo/map?mapUrl=https%3A%2F%2Fraw.githubusercontent.com%2FStrokeOfLuck%2Fncsu-rent-article%2Fmain%2Fdata%2Fkepler%2Fncsu-rent-main-campus_borderline-distance-check.kepler.gl.json" target="_blank" rel="noopener noreferrer">Kepler</a> · Focused manual check of listings closest to the 1-, 3-, and 5-mile cutoffs. Each boundary has separate point and number layers; 1-mile cases open by default. The 5-mile group shows the closest listings inside the cutoff because the audited dataset ends at 5 miles.</div>
